...
public class Main {
    ...
    private static void modifyBank() throws ExistsException {
        ...
        // Employees
        Employee e1 = new Employee("Rajesh", 29, "Jaipur", Gender.MALE, Disability.DISABLED,
                Religion.BUDDHISM);
        Employee e2 = new Employee("Abdul", 22, "Mumbai", Gender.MALE, Disability.HEALTHY,
                Religion.BUDDHISM);
        Employee e3 = new Employee("Arjun", 20, "Ahmedabad", Gender.FEMALE, Disability.HEALTHY,
                Religion.BUDDHISM);
        Employee e4 = new Employee("Brijesh", 39, "Mumbai", Gender.MALE, Disability.DISABLED,
                Religion.BUDDHISM);
        Employee e5 = new Employee("Darsh", 49, "Delhi", Gender.MALE, Disability.DISABLED,
                Religion.CRISTIANITY);
        Employee e6 = new Employee("Ekaraj", 32, "Mumbai", Gender.FEMALE, Disability.HEALTHY,
                Religion.CRISTIANITY);
        Employee e7 = new Employee("Fariq", 25, "Delhi", Gender.MALE, Disability.DISABLED,
                Religion.CRISTIANITY);
        Employee e8 = new Employee("Girik", 50, "Delhi", Gender.FEMALE, Disability.HEALTHY,
                Religion.CRISTIANITY);
        Employee e9 = new Employee("Gunbir", 56, "Jaipur", Gender.FEMALE, Disability.DISABLED,
                Religion.CRISTIANITY);
        Employee e10 = new Employee("Hitesh", 23, "Mumbai", Gender.MALE, Disability.HEALTHY,
                Religion.CALVINISM);
        Employee e11 = new Employee("Jagdish", 46, "Bangalore", Gender.MALE, Disability.HEALTHY,
                Religion.CALVINISM);
        Employee e12 = new Employee("Jairaj", 58, "Mumbai", Gender.FEMALE, Disability.DISABLED,
                Religion.DAOISM);
        Employee e13 = new Employee("Kabir", 42, "Delhi", Gender.MALE, Disability.HEALTHY,
                Religion.DAOISM);
        Employee e14 = new Employee("Krishna", 34, "Ahmedabad", Gender.FEMALE, Disability.DISABLED,
                Religion.DAOISM);
        Employee e15 = new Employee("Mitesh", 18, "Mumbai", Gender.MALE, Disability.ANONIMOUS,
                Religion.HINDUISM);
        Employee e16 = new Employee("Naveen", 27, "Bangalore", Gender.FEMALE, Disability.HEALTHY,
                Religion.HINDUISM);
        Employee e17 = new Employee("Onkar", 37, "Ahmedabad", Gender.FEMALE, Disability.ANONIMOUS,
                Religion.ISLAM);
        Employee e18 = new Employee("Praneel", 49, "Bangalore", Gender.MALE, Disability.ANONIMOUS,
                Religion.ISLAM);
        Employee e19 = new Employee("Ranveer", 52, "Mumbai", Gender.MALE, Disability.DISABLED,
                Religion.ISLAM);
    ...
    private static void printBankReport() {
        ...
        System.out
                .println("---------------- getProjectWorkedOnByMostCustomers test --------------");
        System.out.println();
        System.out.println();
    ...
    private static void printBusinessReport() {
        ...
        System.out.println(BusinessReport.getEmployeesOnSameDisability(business1));
        ...
        System.out.println(
                "---------------- getNumberOfProjectsWorkedByCurrentEmployees test --------------");
        System.out.println();
        System.out.println();

        System.out.println(BusinessReport.getNumberOfProjectsWorkedByCurrentEmployees(business1));
        ...
        System.out.println(
                "---------------- getEmployeesMaxByReligionMaxByGenderSortedByCitySortedByAge " +
                        "test --------------");
        System.out.println();
        System.out.println();

        System.out.println(BusinessReport
                .getEmployeesMaxByReligionMaxByGenderSortedByCitySortedByAge(business1));
        ...
        System.out.println(
                "---------------- getReligionOfEmployeesWithMostAccounts test --------------");
        System.out.println();
        System.out.println();
        ...
        System.out.println(
                "---------------- getEmployeesOnSameReligionAndGender test --------------");
        System.out.println();
        System.out.println();
