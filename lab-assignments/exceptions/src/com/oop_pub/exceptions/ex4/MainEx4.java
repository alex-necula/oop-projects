...
public class MainEx4 {
    ...
    public static void main(final String[] args) {
        ...
        LoggerBase logger2 =
                new EmailLogger(EnumSet.of(LogLevel.FunctionalMessage, LogLevel.FunctionalError));
        ...
        logger1.message("Datele despre adresa clientului lipsesc din baza de date a filialei",
                LogLevel.Warning);
        logger1.message("Detele despre adresa clientului lipsesc din baza de date a organizație",
                LogLevel.Error);
        logger1.message(
                "Nu se poate procesa comanda #Comanda1 datată pe 25.11.2018 pentru clientul " +
                        "#Clientul1",
         ...
         * [Console] Nu se poate procesa comanda #Comanda1 datată pe 25.11.2018 pentru clientul
         * #Clientul1
         * [Email] Nu se poate procesa comanda #Comanda1 datată pe 25.11.2018 pentru clientul
         * #Clientul1
