...
public final class Test {
    ...
    public static void main(final String[] args) {
        ...
        /* See what happens if the TextSegment's accept method is not abstract and the subclasses
         do not override it
         *  - testing this needs changes in the visitor interface as well
         *
         * We would have to create a new method in DocumentVisitor with TextSegment as parameter
         * Using instanceof we would cast TextSegment to the corresponding type and call the
         * correct visitor (not a good solution)
         */
    ...
    public static List<TextSegment> getTextSegments() {
        ...
        textSegments
                .add(new UrlSegment("http://elf.cs.pub.ro/poo/laboratoare/tutorial-doubledispatch",
                        "Tutorialul de double-dispatch"));
        textSegments
                .add(new PlainTextSegment(" oferă mai multe detalii legate de acest mecanism.\n"));
